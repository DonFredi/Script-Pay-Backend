...
import { TenantShortcodesController } from "./tenant-shortcodes.controller";
...
@Module({
  ...
  controllers: [TenantsController, TenantShortcodesController, TenantWebhookConfigController],
  providers: [TenantsService, TenantShortcodesService, CredentialsEncryptionService],
